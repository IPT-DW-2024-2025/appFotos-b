...
namespace appFotos.Data.DbInitializerDev;
...
public class DbInitializer
{
    internal static async void Initialize(ApplicationDbContext dbContext) {
     ...
     if (dbContext.Categorias.Count() == 0) {
        categorias = [
     ...
     if (!dbContext.Utilizadores.Any()) {
        utilizadores = [
           new Utilizadores { Nome="João Mendes", Morada="Rua das Flores, 45", CodPostal="2300-000 TOMAR", Pais="Portugal", NIF="123456789", Telemovel="919876543" , IdentityUserName= newIdentityUsers[0].UserName },
           new Utilizadores { Nome="Maria Sousa", NIF="123459876", IdentityUserName= newIdentityUsers[1].UserName, Telemovel="919876543"  },
           new Utilizadores { Nome="Ana Paula Silva", NIF="123459867", Telemovel="935678921", IdentityUserName=newIdentityUsers[2].UserName  }
          ];
